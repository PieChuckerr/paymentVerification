...
public class HttpClient
{
	...
	public String sendHttpGet(String url) throws Exception
	{
		...
		try
		{
			...
			try
			{
				...
				//System.out.println("Sending HTTP GET request to URL : " + url + " + ResponseCode:" + responseCode);
	...
	public String sendHttpsGet(String url) throws Exception
	{
		...
		try
		{
			...
			try
			{
				...
				//System.out.println("Sending HTTPS GET request to URL : " + url + " + ResponseCode:" + responseCode);
	...
	public String sendHttpPost(String url, String urlParams) throws Exception
	{
		...
		try
		{
			...
			try
			{
				...
				//System.out.println("Sending HTTP POST request to URL : " + url + " + Params:" + urlParams + " + ResponseCode:" + responseCode);
	...
	public String sendHttpsPost(String url, String urlParams) throws Exception
	{
		...
		try
		{
			...
			//System.out.println("Sending HTTPS POST request to URL : " + url + " + Params:" + urlParams + " + ResponseCode:" + responseCode);
